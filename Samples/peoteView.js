...
MainJS.prototype = $extend(lime_app_Application.prototype,{
	onWindowCreate: function(window) {
		{
			...
			case 0:
				...
				MainJS.startTime = haxe_Timer.stamp();
				onLimeEmbed();;
				break;
			default:
				null;
	...
	,render: function(renderer) {
		MainJS.peoteView.render(Math.floor((haxe_Timer.stamp() - MainJS.startTime) * 100) / 100,this.width,this.height,this.mouse_x,this.mouse_y,this.zoom,this.xOffset,this.yOffset);
	}
	,onWindowResize: function(window,width,height) {
		this.width = window.__width;
		this.height = window.__height;
